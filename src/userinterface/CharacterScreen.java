...
public class CharacterScreen extends JFrame{
	...
	// Creation of all elements for the Main GUI screen
		...
		static Character player = Character.getInstance();
		static MyButton strength_button = new MyButton(player, "Strength");
		static MyButton dexterity_button = new MyButton(player, "Dexterity");
		static MyButton intelligence_button = new MyButton(player, "Intelligence");
		static MyButton wisdom_button = new MyButton(player, "Wisdom");
		static MyButton charisma_button = new MyButton(player, "Charisma");
		static MyButton constitution_button = new MyButton(player, "Constitution");
		static MyButton kindness_button = new MyButton(player, "Kindness");
			...
			public CharacterScreen(Character player) {
				...
				JLabel name = new JLabel ("Player Name: "+ player.getName());
				name_level.add(name);
